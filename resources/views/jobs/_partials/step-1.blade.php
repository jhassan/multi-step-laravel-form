            ...
            <div class="col-lg-6 col-md-12">
                ...
                <div class="input-form">
                    <select class="form-control" name="role">
                        ...
                        <option value="1">Audit Controller </option>
                        <option value="2">CFA</option>
                        <option value="3">Tax Controller </option>
                    </select>
            ...
            <div class="col-lg-6 col-md-12">
                ...
                <div class="input-form">
                    <select class="form-control" name="english_proficiency">
                        ...
                        <option id="BEGINNER" name="Beginner A1/A2" value="1" value="BEGINNER">
                            Beginner A1/A2
                        </option>
                        <option id="INTERMEDIATE" name="Intermediate B1/B2" value="2"
                            value="INTERMEDIATE">Intermediate B1/B2
                        </option>
                        <option id="ADVANCED" name="Advanced C1/C2" value="3" value="ADVANCED">
                            Advanced C1/C2
                        </option>
                        <option id="NATIVE" name="Native" value="4" value="NATIVE">
                            Native
                        </option>
                    </select>
